const MESSAGE = {
  ERROR: {
    ...
    CATEGORY_REG: 'Unable to register category',
    PRODUCT_REG: 'Unable to register product',
    USER_REG: 'Unable to register user',
    PURCHASE_REG: 'Unable to register this purchase',
    DISCOUNT_REG: 'Unable to register discount',
